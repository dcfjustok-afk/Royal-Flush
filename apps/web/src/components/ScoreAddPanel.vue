...
<template>
  <form class="score-add-panel" @submit.prevent="submit">
    ...
    <div class="score-input-wrap"><input id="score-amount" v-model.number="amount" type="number" min="1" max="1000000000" step="1" inputmode="numeric" required /><button class="button primary" type="submit"><Plus />增加</button></div>
